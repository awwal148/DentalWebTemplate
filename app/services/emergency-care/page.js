...
export default function Emergencycare() {
  return (
    <>
      <Head>
        <title>Emergency Care | SmileCare Dental Clinic</title>
        <meta
          name="description"
          content="Explore our comprehensive general teeth cleaning services including cleanings, exams, fillings, and preventive care for all ages."
        />
        <meta name="keywords" content="Teeth cleaning, dental exams, teeth cleaning, fillings, oral health" />
      ...
      <main className="bg-white text-gray-800">
        ...
        <div className="bg-gray-50 py-8 px-6 mt-[5rem]">
          <h1 className="text-3xl font-bold text-center">Dental Emergency in High Wycombe</h1>
        ...
        <section className="max-w-5xl mx-auto px-6 mb-12">
          <h2 className="text-2xl font-semibold mb-4">About Dental Emergency Services</h2>
