...
export default function Dentalimplant() {
  return (
    <>
      <Head>
        <title>Dental-implant | SmileCare Dental Clinic</title>
        <meta
          name="description"
      ...
      <main className="bg-white text-gray-800">
        ...
        <div className="bg-gray-50 py-8 px-6 mt-[5rem]">
          <h1 className="text-3xl font-bold text-center">Dental Implant in High Wycombe</h1>
        ...
        <section className="max-w-5xl mx-auto px-6 mb-12">
          <h2 className="text-2xl font-semibold mb-4">About Dental Implant Services</h2>
